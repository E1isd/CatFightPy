...
class Ability:
    ...
    # Kriegerfähigkeiten
        ...
        self.knock_out = {"name": "Knock Out", "mp_cost":5,"tooltip":"Causes a moderate amount of damage and stuns the enemy for 1 turn.","target":"enemy","t_number":"single","method":"knock_out"}
