...
class Inventory:
    ...
    # für die Tooltip Box gespeichert.
        self.item_dict = {
            "Potion":{"name":"Potion","in_stock":3,"action":"heal","value":250,"tooltip":"Heals target cat"},
            "Antidote":{"name":"Antidote","in_stock":2,"action":"cure","status_effect":"poison","value":0,"tooltip":"Cures poision"},
            "Catnip":{"name":"Catnip","in_stock":2,"action":"revive","value":100,"tooltip":"Revives fallen cat"},
