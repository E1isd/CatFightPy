...
class Effects():
    ...
    def __init__(self):
        ...
        self.dict_cleric_pray = {"image":"images/Character/Cleric/Cleric-pray-sheet.png","size":48,"scale":3, "frames":7,"effect_start":1,"wait": False,"loop":True,"loop-start":5,"loop_frames":2}
